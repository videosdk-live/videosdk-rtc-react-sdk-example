...
function ParticipantGrid({
  ...
  const perRow = isMobile || isPresenting
  ...
  return (
    <div
      className={`relative flex flex-col md:flex-row flex-grow m-3 items-center justify-center ${participantIds.length < 2 && !sideBarMode && !isPresenting
        ? "md:px-16 md:py-2"
